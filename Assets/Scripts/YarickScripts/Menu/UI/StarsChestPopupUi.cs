...
namespace Menu.UI
{
    public sealed class StarsChestPopupUi : MonoBehaviour
    {
        [Header("UI")]
        ...
        private void Render()
        {
            ...
            int coins = save.starsChest.progress;
            int cap = (_menu.starsChestConfig != null) ? _menu.starsChestConfig.threshold : 0;
