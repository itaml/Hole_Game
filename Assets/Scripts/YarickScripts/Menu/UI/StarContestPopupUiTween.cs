...
namespace Menu.UI
{
    public sealed class StarContestPopupUiTween : MonoBehaviour
    {
        ...
        [Header("Show")]
        [SerializeField] private float overlayFade = 0.18f;
        [SerializeField] private float panelFade = 0.14f;
        [SerializeField] private float panelTime = 0.24f;
        [SerializeField] private float panelStartScaleMul = 0.86f;
        [SerializeField] private float panelFromY = -55f;

        [Header("Hide")]
        [SerializeField] private float hideTime = 0.14f;
